        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    {{ __('Manage and restore archived company records') }}
                </p>
            </div>

            <div class="flex items-center gap-3">
                <a href="{{ route('company.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-xl font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            ...
                            @forelse ($companies as $company)
                                <tr class="bg-gray-50/30">
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-400 font-bold text-lg">
                                                {{ substr($company->name, 0, 1) }}
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-bold text-gray-600">{{ $company->name }}</div>
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 font-medium">{{ __('No archived companies found.') }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse 
